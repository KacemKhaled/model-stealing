...
import ms.models.cifar
import ms.models.imagenet
import ms.models.mnist
import torch
...
def get_net(modelname, modeltype, pretrained=None, **kwargs):
    ...
    if pretrained and pretrained is not None:
        ...
        try:
            ...
            model = eval('ms.models.{}.{}'.format(modeltype, modelname))(**kwargs)
            ...
            model = eval('ms.models.{}.{}'.format(modeltype, modelname))()
...
def get_pretrainednet(modelname, modeltype, pretrained='imagenet', num_classes=1000, **kwargs):
    if pretrained == 'imagenet':
        ...
        try:
            # This should have ideally worked:
            model = eval('ms.models.{}.{}'.format(modeltype, modelname))(num_classes=num_classes, **kwargs)
        except AssertionError:
...
def get_imagenet_pretrainednet(modelname, num_classes=1000, **kwargs):
    ...
    model = ms.models.imagenet.__dict__[modelname](pretrained='imagenet')
    if num_classes != 1000:
